...
solve.pbk.sa33 <-cbind(solve.pbk.sa33,solve33$C_V)
colnames(solve.pbk.sa33) <- c("time","C_V")
...
solve.pbk.sa34 <-cbind(solve.pbk.sa34,solve34$C_V)
colnames(solve.pbk.sa34) <- c("time","C_V")
...
solve.pbk.sa35 <-cbind(solve.pbk.sa35,solve35$C_V)
colnames(solve.pbk.sa35) <- c("time","C_V")
...
solve.pbk.sa36 <-cbind(solve.pbk.sa36,solve36$C_V)
colnames(solve.pbk.sa36) <- c("time","C_V")
...
solve.pbk.sa37 <-cbind(solve.pbk.sa37,solve37$C_V)
colnames(solve.pbk.sa37) <- c("time","C_V")
...
solve.pbk.sa38 <-cbind(solve.pbk.sa38,solve38$C_V)
colnames(solve.pbk.sa38) <- c("time","C_V")
...
solve.pbk.sa39 <-cbind(solve.pbk.sa39,solve39$C_V)
colnames(solve.pbk.sa39) <- c("time","C_V")
...
solve.pbk.sa40 <-cbind(solve.pbk.sa40,solve40$C_V)
colnames(solve.pbk.sa40) <- c("time","C_V")
...
solve.pbk.sa41 <-cbind(solve.pbk.sa41,solve41$C_V)
colnames(solve.pbk.sa41) <- c("time","C_V")
...
solve.pbk.sa42 <-cbind(solve.pbk.sa42,solve42$C_V)
colnames(solve.pbk.sa42) <- c("time","C_V")
...
solve.pbk.sa43 <-cbind(solve.pbk.sa43,solve43$C_V)
colnames(solve.pbk.sa43) <- c("time","C_V")
...
solve.pbk.sa44 <-cbind(solve.pbk.sa44,solve44$C_V)
colnames(solve.pbk.sa44) <- c("time","C_V")
...
solve.pbk.sa45 <-cbind(solve.pbk.sa45,solve45$C_V)
colnames(solve.pbk.sa45) <- c("time","C_V")
...
solve.pbk.sa46 <-cbind(solve.pbk.sa46,solve46$C_V)
colnames(solve.pbk.sa46) <- c("time","C_V")
...
solve.pbk.sa47 <-cbind(solve.pbk.sa47,solve47$C_V)
colnames(solve.pbk.sa47) <- c("time","C_V")
...
solve.pbk.sa48 <-cbind(solve.pbk.sa48,solve48$C_V)
colnames(solve.pbk.sa48) <- c("time","C_V")
...
solve.pbk.sa49 <-cbind(solve.pbk.sa49,solve49$C_V)
