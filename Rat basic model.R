...
PBK_Cinnamaldehyde <- RxODE({
  ...
  RM_SI_CHEM     <- k_GSH * C_V_SI * C_SIc_GSH * V_SI;             #Rate of Cinnamaldehyde binding in the small intestine to GSH in umol/h
  RM_SI_CA       <- k_SI_CA * C_V_SI;                              #Rate of Cinnamaldehyde enzymatically oxidized to cabroxylic acid in the small intestine in μmol/h
  ...
  C_Lc_GSH       <- AM_Lc_GSH / V_L;                    #Concentration of GSH in the liver cytosol in umol/kg  
  ...
  RM_L_CHEM      <- k_GSH * C_V_L * C_Lc_GSH * V_L;     #Rate of Cinnamaldehyde chemically binding to GSH in the liver in umol/h
  ...
  RM_Lc_GSH      <- G_SYN_L * 0.9 - (RM_L_GST + RM_L_CHEM + k_L_GLOS * AM_Lc_GSH);      #Rate of change in GSH concentration in the liver cytosol umol/h
