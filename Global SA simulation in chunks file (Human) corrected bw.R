phys <- read_csv("GSA_phys_human_2.8mg_inhalation_corrected")
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=117501:120000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
