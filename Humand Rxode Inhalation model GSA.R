...
PBK_Cinnamaldehyde <- RxODE({
  ...
  C_P_Art       <-((Q_F + Q_L + Q_SI + Q_RP + Q_SP) * C_V + -R_Inhalation )/((Q_F + Q_L + Q_SI + Q_RP + Q_SP) + P_V/P_B);        #Concentration of Cinnamaldehyde  in Arterial blood leaving the lung in  μmol/l
  ...
  R_Pu           <- (Q_F + Q_L + Q_SI + Q_RP + Q_SP) * (C_P_Art - C_A_Pu);           #Rate of change in the concentration of Cinnamaldehyde  in μmol/h
  ...
  R_OH_Pu        <- (Q_F + Q_L + Q_SI + Q_RP + Q_SP) * (C_OH_V - C_OH_V_Pu);        #Rate of change in Cinnamyl alcOHol concentration in the lung in μmol/h
  ...
  R_OH_M_L_C_A   <- k_L_OH * C_OH_V_L;                              #Rate of Cinnamyl alcOHol oxidized to cinnamaldehyde in the liver in umo/h
  ...
  #----------------Blood------------------------#
  #Cinnamaldehyde#
  R_V            <- Q_F * C_V_F + (Q_L + Q_SI) * C_V_L + Q_RP * C_V_RP + Q_SP * C_V_SP - (Q_F + Q_L + Q_SI + Q_RP + Q_SP) * C_V;       #Rate of change in Cinnamaldehyde concentration in the venous blood in μmol
  
  R_A            <- (Q_F + Q_L + Q_SI + Q_RP + Q_SP) * C_A_Pu - (Q_F * C_A + Q_L * C_A + Q_SI * C_A + Q_RP * C_A + Q_SP * C_A );       #Rate of change in Cinnamaldehyde concentration in the arterial blood in μmol 
  
  #Cinnamyl alcohol
  R_OH_V         <- Q_F * C_OH_V_F + (Q_L + Q_SI) * C_OH_V_L + Q_RP * C_OH_V_RP + Q_SP * C_OH_V_SP - (Q_F + Q_L + Q_SI + Q_RP + Q_SP) * C_OH_V; 
  R_OH_A         <- (Q_F + Q_L + Q_SI + Q_RP + Q_SP) * C_OH_V_Pu - (Q_F * C_OH_A + Q_L * C_OH_A + Q_SI * C_OH_A + Q_RP * C_OH_A + Q_SP * C_OH_A);
