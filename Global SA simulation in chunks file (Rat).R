phys <- read_csv("RAT_250mg_oral_phys_0.2ka")
...
Km_L_OH <- phys$Km_L_OH
k_L_CA<- phys$k_L_CA
k_SI_CA <- phys$k_SI_CA
Vsmax_L_OH<-phys$Vsmax_L_OH

parameters1<-cbind(Volume_exposure_chamber,
                 P_F,
                 P_L,
                 P_SI,
                 P_RP,
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=12501:15000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=15001:17500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=17501:20000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=20001:22500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=22501:25000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=25001:27500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=27501:30000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=30001:32500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=32501:35000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=35001:37500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=37501:40000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=40001:42500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=42501:45000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=45001:47500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=47501:50000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=50001:52500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=52501:55000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=55001:57500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=57501:60000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=60001:62500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=62501:65000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=65001:67500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=67501:70000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=70001:72500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=72501:75000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=75001:77500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=77501:80000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=80001:82500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=82501:85000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=85001:87500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=87501:90000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=90001:92500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=92501:95000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=95001:97500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=97501:100000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=100001:102500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=102501:105000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=105001:107500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=107501:110000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=110001:112500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=112501:115000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=115001:117500,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=117501:118000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=122501:124000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
...
ex1 <- eventTable(amount.units = amount.units, time.units = time.units) %>%
  ...
  et(id=125001:126000,amt=(Inhalation_Dose_in_mg_bw) * Data_BW$BW/ MW  * 1e+3 , dur=0.08, cmt="A_inhalation_Dose", nbr.doses=nbr.doses)%>%
